...
DROP TABLE SUPPLIER;
create table customer (CUS_ID int primary key,CUS_NAME varchar(50) NOT NULL,CUS_PHONE varchar(50)NOT NULL,CUS_CITY VARCHAR(30) NOT NULL,CUS_GENDER CHAR);
DROP TABLE CUSTOMER;
CREATE TABLE CATEGORY(CAT_ID INT PRIMARY KEY, CAT_NAME VARCHAR(20) NOT NULL);
CREATE TABLE PRODUCT (PRO_ID INT NOT NULL, PRO_NAME VARCHAR(20) NOT NULL DEFAULT "Dummy",PRO_DESC VARCHAR (60), CAT_ID INT NOT NULL,
PRIMARY KEY (PRO_ID),
...
==checking all the data into the table
